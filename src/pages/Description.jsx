  ...
  return (
    <div className="screenHeight w-full bg-[#ffe9ff] border-[2px] ">
      ...
      <div className="relative w-full mainBox3 flex flex-col ">
        ...
        <p>
          I state that the picture and personal details shared by me are true
          and accurate and the company shall not have any liability arising from
          its reliance on the same. I understand that no data will be retained
          by the company post the event. I agree that the all contents used for
          promotion of the event shall be the property of GE, and meant for its
          use only.
        </p>
